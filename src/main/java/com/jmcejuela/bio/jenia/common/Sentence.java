 ...
 *
 * This class is not anymore generic, as it is known at compile & run time that is a sequence of tokens. Consequently it
 * can know how to clone/copy itself. This is necessary to simulate c++ behavior as the assignment of objects (in
 * particular for vector<Token>) creates deep copies of them. Use the method {@link #copy()} for this purpose.
 */
